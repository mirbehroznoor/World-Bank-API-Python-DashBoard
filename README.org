...
+ [[https://devcenter.heroku.com/articles/heroku-cli][Heroku: Heroku CLI Setup]]
+ [[https://austinlasseter.medium.com/how-to-deploy-a-simple-plotly-dash-app-to-heroku-622a2216eb73][Medium: How to deploy a simple plotly dash app to heroku]]
+ [[https://dash.plotly.com/deployment][Dash-Plotly: Deployment]]
