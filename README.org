...
** Windows 10 [[https://github.com/mirbehroznoor/World-Bank-API-Python-DashBoard/blob/main/Windows_Instructions.txt][Windows Instructions]]
...
**** Second Option:
_/The following instructions may not be accurate/_
****** Install PyCharm
****** Create a Project
