...
** Dash App Versions
*** Simple App
It is one variable app where user can only change y-axis variable while x-axis is by default, year variable. It accepts only one variable while it is possible to add as many economies as possible.
